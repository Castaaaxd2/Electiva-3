...
export const SPECIES_DATA: Record<string, SpeciesInfo> = {
  ...
  "chulo": {
    ...
    habitat: "Zonas abiertas, vertederos, bordes de carretera, zonas rurales y urbanas",
  ...
  "colibrí cola canela": {
    ...
    habitat: "Jardines, bordes de bosque, plantaciones de café y áreas abiertas con flores",
  ...
  "colibrí cola de raqueta": {
    ...
    habitat: "Bosques andinos húmedos, bordes de bosque y jardines entre 1000 y 2500 m de altitud",
  ...
  "copetón": {
    ...
    habitat: "Parques, jardines, potreros, cultivos y zonas urbanas con vegetación",
  ...
  "cucarachero común": {
    ...
    habitat: "Matorrales, jardines, áreas con vegetación densa y bordes de bosque",
  ...
  "eufonia piquigruesa": {
    ...
    habitat: "Bordes de bosque, jardines, zonas arboladas y cultivos con árboles frutales",
  ...
  "garza ganadera": {
    ...
    habitat: "Potreros, pastizales con ganado, orillas de ríos y zonas agrícolas",
  ...
  "gavilan caminero": {
    ...
    habitat: "Bordes de bosque, sabanas, jardines, zonas rurales y orillas de carretera",
  ...
  "golondrina azul y blanco": {
    ...
    habitat: "Ciudades, zonas rurales, orillas de ríos, lagunas y áreas abiertas",
  ...
  "golondrina yucateca": {
    ...
    habitat: "Zonas abiertas, campos agrícolas, ríos, lagunas y áreas urbanas durante la migración",
  ...
  "luis bienteveo": {
    ...
    habitat: "Bordes de bosque, jardines, parques, riberas y zonas urbanas arboladas",
  ...
  "mango gorjinegro": {
    ...
    habitat: "Bordes de bosque, jardines, sabanas arboladas y zonas con heliconias",
  ...
  "papamoscas rayado chico": {
    ...
    habitat: "Bosques andinos húmedos, bordes de bosque montano entre 1000 y 3000 m",
  ...
  "perico carisucio": {
    ...
    habitat: "Sabanas, bosques secos, zonas agrícolas, jardines y áreas urbanas",
  ...
  "rascón chiricote": {
    ...
    habitat: "Manglares, bosques de galería, pantanos, arrozales y orillas de ríos con vegetación densa",
  ...
  "semillero común": {
    ...
    habitat: "Pastizales, matorrales, bordes de cultivos, potreros y zonas abiertas",
  ...
  "tangara azulegris": {
    ...
    habitat: "Bordes de bosque, jardines, parques, zonas arboladas urbanas y plantaciones",
  ...
  "tangara dorada": {
    ...
    habitat: "Bosques andinos húmedos y bordes de bosque entre 900 y 2200 m de altitud",
  ...
  "tirano pirirí": {
    ...
    habitat: "Zonas abiertas, bordes de bosque, orillas de ríos, parques y jardines",
  ...
  "tordo negro": {
    ...
    habitat: "Zonas agrícolas, potreros, bordes de bosque, jardines y áreas urbanas",
  ...
  "tortolita común": {
    ...
    habitat: "Pastizales, potreros, jardines, cultivos y zonas abiertas con vegetación baja",
  ...
  "vireón cejas canela": {
    ...
    habitat: "Bordes de bosque, jardines, zonas arboladas y bosques secundarios",
  ...
  "zorzal sabiá": {
    ...
    habitat: "Bosques secundarios, bordes de bosque, jardines y zonas arboladas",
    diet: "Lombrices, insectos, frutos y bayas",
    conservationStatus: "Preocupación menor",
  },
};
